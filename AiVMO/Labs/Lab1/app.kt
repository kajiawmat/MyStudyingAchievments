...
fun methodJordanGauss(A: MutableList<MutableList<Frac>>, B: MutableList<Frac>, SetNum: MutableList<Int>)
{
	var max: Int?
	var n=A[0].size
	var m=A.size
	...
	if(r<n) println("System has infinite solution")
	else println("System has one solution")
...
fun main(){
	...
	methodJordanGauss(Matr,Vect_B,SetNum)
}