 ...
 * Use the [CompasView1.newInstance] factory method to
 * create an instance of this fragment.
 */
class CompasView1 : Fragment(), CompasInterface {
    ...
    override fun onCreateView(
        ...
        view = inflater.inflate(R.layout.fragment_compas_view1, container, false)
        return view
    }
